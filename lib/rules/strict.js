...
module.exports = function(context) {
    ...
    /**
     * Get the line ending type used in this source file
     * @returns {string} line term char(s)
     */
    function getLineEnding() {
        return lineEnding || (lineEnding = (/\r\n|\n/.exec(context.getSourceCode().text) || ["\n"])[0]);
    }
            ...
            "Program": function(node) {
                ...
                if (node.body.length > 0 && useStrictDirectives.length === 0) {
                    context.report({
                        ...
                        fix: function(fixer) {
                            return fixer.insertTextBefore(node, "\"use strict\";" + getLineEnding());
                        }
                    });
                } else {
